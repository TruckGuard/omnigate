...
export const api = {
  ...
  configs: {
    ...
    update: (id: string, d: Partial<Pick<DeviceConfig, 'event_type_id' | 'gate_id' | 'data_type' | 'data_mapping' | 'trigger_url' | 'trigger_enabled' | 'triggers' | 'image_fields' | 'await_source_ids' | 'await_ttl_seconds'>>) =>
